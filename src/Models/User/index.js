class UserModel {
    constructor(userId, fullName, email, phone, type, members, wallet, status, ownStr, memStr, usable, earning, createdAt, updatedAt, bankName, accountNo, IFSC, holder, aadhar, pan, nomineeName, sign, street1, street2, city, state, country, postalCode, rentCount, unread) {
        this.id = userId;
