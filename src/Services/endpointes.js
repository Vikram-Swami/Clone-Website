...
export const uploadDocuments = "/upload-documents";
...
export const createRoyalty = "/create-Royalty";
...
export const registerNetworkUser = "/register-Knocial-user";
export const activateConnection = "/activate-connection";
